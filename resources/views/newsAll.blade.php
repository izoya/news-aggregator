...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .p-3{padding: 0.7rem;}
            .bg-gray-200{background-color: #dcdede;}
            .max-w-3xl{max-width:36rem}
        </style>
    ...
    <body class="antialiased">
        ...
        <div class="flex justify-center">
            <div class="max-w-3xl p-3">
                <p class="p-6 bg-gray-100 ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci
                    aliquam
                    asperiores commodi
                    consequuntur corporis culpa cumque error iste iure modi natus, non officiis quaerat quo ratione rem
                    sapiente vel.
                    <a href="{{ url('/news/1') }}" class="text-sm text-gray-700 underline block p-3">Read more...</a>
                </p>
                <hr>
            </div>
            <div class="max-w-3xl p-3">
                <p class="p-6 bg-gray-100 ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci
                    ...
                    consequuntur corporis culpa cumque error iste iure modi natus, non officiis quaerat quo ratione rem
                    sapiente vel.
                    <a href="{{ url('/news/2') }}" class="text-sm text-gray-700 underline block p-3">Read more...</a>
                </p>
                <hr>
            </div>
            <div class="max-w-3xl p-3">
                <p class="p-6 bg-gray-100 ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci
                    ...
                    consequuntur corporis culpa cumque error iste iure modi natus, non officiis quaerat quo ratione rem
                    sapiente vel.
                    <a href="{{ url('/news/3') }}" class="text-sm text-gray-700 underline block p-3">Read more...</a>
                </p>
                <hr>
            </div>
